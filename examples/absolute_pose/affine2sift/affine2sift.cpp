...
void affine2sift_solver(Eigen::MatrixXd const &A, double q1, std::vector<double> *r1, std::vector<double> *r2) {
    ...
    static const int coeffs0_ind[] = {0, 6, 0, 6, 7,  0, 2, 6, 9, 1, 7, 8, 1, 8,
                                      1, 3, 7, 8, 10, 0, 2, 6, 7, 9, 2, 4, 9, 11};
    static const int coeffs1_ind[] = {5,  13, 3, 5, 10, 13, 1, 3,  8,  10, 3,  5,  10, 12,
                                      13, 2,  4, 9, 11, 12, 5, 12, 13, 4,  11, 12, 4,  11};

    static const int C0_ind[] = {3,  7,  10, 14, 15, 17, 19, 21, 23, 27, 30, 31, 34, 38,
                                 41, 43, 44, 45, 47, 48, 50, 52, 53, 54, 57, 59, 61, 63};

    static const int C1_ind[] = {0,  4,  8,  10, 12, 14, 16, 18, 20, 22, 25, 27, 29, 30,
                                 31, 32, 34, 36, 38, 39, 41, 44, 45, 48, 52, 53, 57, 61};
